...
//     if (!user?.isPro &&
//        !["javascript"].includes(args.language.toLowerCase()) && 
//        !["react"].includes(args.language.toLowerCase()) && 
//        !["jsx"].includes(args.language.toLowerCase()) && 
//       !["cpp"].includes(args.language.toLowerCase()) &&
//        !["java"].includes(args.language.toLowerCase()) && 
//       !["python"].includes(args.language.toLowerCase())) {
